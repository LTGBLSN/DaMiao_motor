    ...
    if(hcan == &hcan1)
    {
        ...
        switch (can1_RxHead.StdId)
        {
            case (0x11):
            {
                ...
                DM4310_01.state = (can1_data[0]) >> 4;
                p_int = (can1_data[1] << 8) | can1_data[2];
                v_int = (can1_data[3] << 4) | (can1_data[4] >> 4);
                t_int = ((can1_data[4] & 0xF) << 8) | can1_data[5];
                DM4310_01.return_angle = uint_to_float(p_int, DM8009P_P_MIN, DM8009P_P_MAX, 16);
                DM4310_01.return_speed = uint_to_float(v_int, DM8009P_V_MIN, DM8009P_V_MAX, 12);
                DM4310_01.return_tor = uint_to_float(t_int, DM8009P_T_MIN, DM8009P_T_MAX, 12);
                DM4310_01.Tmos = (float )(can1_data[6]);
                DM4310_01.Tcoil = (float )(can1_data[7]);
