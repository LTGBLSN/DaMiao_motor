...
void DM_MOTOR_TASK(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of dmmotor */
  osThreadDef(dmmotor, DM_MOTOR_TASK, osPriorityIdle, 0, 128);
  dmmotorHandle = osThreadCreate(osThread(dmmotor), NULL);
...
/* USER CODE BEGIN Header_DM_MOTOR_TASK */
/**
* @brief Function implementing the dmmotor thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_DM_MOTOR_TASK */
__weak void DM_MOTOR_TASK(void const * argument)
{
  /* USER CODE BEGIN DM_MOTOR_TASK */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END DM_MOTOR_TASK */
}
